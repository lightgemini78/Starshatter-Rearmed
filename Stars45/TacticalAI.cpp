...
TacticalAI::CheckFlightPlan()
{
	...
	if (navpt) {
		...
		case Instruction::VECTOR:  roe = FLEXIBLE; //DEFENSIVE; //SELF_DEFENSIVE;
			break;
...
TacticalAI::FindFormationSlot(int formation)
{
	...
	if (formation == Instruction::BOX) {
		...
		case 5:  delta = Point( 7,  7,  -7); break;
		case 6:  delta = Point( 7, -7,  -7); break;
		}
	}
