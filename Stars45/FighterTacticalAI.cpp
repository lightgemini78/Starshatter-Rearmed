...
//		case 5:  delta = Point( 24, -3, -25); break;
//		case 6:  delta = Point(-24, -3, -25); break;
		case 2:  delta = Point(  6,  0, -12); break;
		case 3:  delta = Point( -6,  0, -12); break;
		case 4:  delta = Point(  0,  6,  -6); break;
		case 5:  delta = Point(  3, -6,  -6); break;
		case 6:  delta = Point( -3, -6,  -6); break;
		}
	}
	...
	if (formation == Instruction::SPREAD) {
	    ...
	    case 5:  delta = Point( 30, 0, 0); break;
        case 6:  delta = Point( 45, 0, 0); break;
		}
	}
	...
	if (formation == Instruction::BOX) {
		switch (element_index) {
		case 2:  delta = Point( 15,  0,   15); break;
		case 3:  delta = Point(-15, -30,  15); break;
		case 4:  delta = Point( 15, -30, -15); break;
		case 5:  delta = Point(-15,  0,  -15); break;
        case 6:  delta = Point(  0, -30,  -5); break;
		}
	}
